      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2">
          <div className="flex items-center">
            <img src={YoutubeLogo} alt="Drawer Logo" style={{ width: "50%", height: "100%" }} />
          </div>
          <button
        ...
        <div className="flex flex-col  px-4 py-2 space-y-4">
          ...
          {/* Menu Items */}
          <button className="flex items-center space-x-2" style={{ marginTop: "20px" }} onClick={() => navigate("/user/categories")}>
          ...
          <button className="flex items-center space-x-2" onClick={() => navigate("/user/videosUpload")} style={{ marginTop: "20px" }}>
            <FaUpload />
            <span>Upload Video</span>
          </button>
          <button className="flex items-center space-x-2" onClick={() => navigate("/user/shortsUpload")} style={{ marginTop: "20px" }}>
            <FaUpload />
