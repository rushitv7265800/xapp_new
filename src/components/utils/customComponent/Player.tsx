...
import { usePlyr } from "./Preact-player";
      ...
      const quality: Options["quality"] = {
       ...
       user. */
        onChange: (newQuality: number) => {
          ...
          levels.forEach((level:any, levelIndex:any) => {
...
interface HlsPlayerProps extends PlyrProps {
  hlsSource?: any,

}
const PlyrComponent = React.forwardRef<APITypes, HlsPlayerProps>((props, ref) => {
