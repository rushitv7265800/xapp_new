...
const instantiate = (_: any, params: any) => {
...
function usePlyr(ref: any, params: any, deps = null) {
    return useAptor(
        ref,
        {
            instantiate,
...
const Plyr = forwardRef((props: PlayerProps, ref) => {
